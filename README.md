...
| No. | Questions                                                                                                                                                         |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
Ques :- 1 What are the possible ways to create objects in JavaScript
Ques :- 2 What is prototype chain ? 
Ques :- 3 What is the difference between Call, Apply and Bind
Ques :- 4 What is JSON and its common operations
Ques :- 5 What is the purpose of the array slice method
Ques :- 6 What is the purpose of the array splice method
Ques :- 7 What is the difference between slice and splice
Ques :- 8 How do you compare Object and Map
Ques :- 9 What is the difference between == and === operators 
Ques :- 10 What are lambda or arrow functions
Ques :- 11 What is a first class function
Ques :- 12 What is a first order function
Ques :- 13 What is a higher order function
Ques :- 14 What is a unary function                                                                                                             |
Ques :- 15 What is the currying function
Ques :- 16 What is a pure function
Ques :- 17 What is the purpose of the let keyword
Ques :- 18 What is the difference between let and var 
Ques :- 19 What is the reason to choose the name let as a keyword
Ques :- 20 How do you redeclare variables in switch block without an error
Ques :- 21 What is the Temporal Dead Zone
Ques :- 22 What is IIFE(Immediately Invoked Function Expression)
Ques :- 23 How do you decode or encode a URL in JavaScript ?
Ques :- 24 What is memoization 
Ques :- 25 What is Hoisting
Ques :- 26 What are classes in ES6
Ques :- 27 What are closures
Ques :- 28 What are modules
Ques :- 29 Why do you need modules
Ques :- 30 What is scope in javascript
Ques :- 31 What is a service worker
Ques :- 32 How do you manipulate DOM using a service worker
Ques :- 33 How do you reuse information across service worker restarts  
Ques :- 34 What is IndexedDB
Ques :- 35 What is web storage
Ques :- 36 What is a post message
Ques :- 37 What is a cookies
Ques :- 38 Why do you need a Cookie
Ques :- 39 What are the options in a cookie
Ques :- 40 How do you delete a cookie
Ques :- 41 What are the differences between cookie, local storage and session storage
Ques :- 42 What is the main difference between localStorage and sessionStorage
Ques :- 43 How do you access web storage 
Ques :- 44 What are the methods available on session storage 
Ques :- 45 What is a storage event and its event handler
Ques :- 46 Why do you need web storage
Ques :- 47 How do you check web storage browser support 
Ques :- 48 How do you check web workers browser support
Ques :- 49 Give an example of a web worker
Ques :- 50 What are the restrictions of web workers on DOM
Ques :- 51 What is a promise
Ques :- 52 Why do you need a promise
Ques :- 53 What are the three states of promise
Ques :- 54 What is a callback function
Ques :- 55 Why do we need callbacks 
Ques :- 56 What is a callback hell 
Ques :- 57 What are server-sent events 
Ques :- 58 How do you receive server-sent event notifications
Ques :- 59 How do you check browser support for server-sent events
Ques :- 60 What are the events available for server sent events
Ques :- 61 What are the main rules of promise
Ques :- 62 What is callback in callback
Ques :- 63 What is promise chaining
Ques :- 64 What is promise.all
Ques :- 65 What is the purpose of the race method in promise
Ques :- 66 What is a strict mode in javascript
Ques :- 67 Why do you need strict mode
Ques :- 68 How do you declare strict mode
Ques :- 69 What is the purpose of double exclamation
Ques :- 70 What is the purpose of the delete operator
Ques :- 71 What is typeof operator
Ques :- 72 What is undefined property
Ques :- 73 What is null value
Ques :- 74 What is the difference between null and undefined
Ques :- 75 What is eval
Ques :- 76 What is the difference between window and document
Ques :- 77 How do you access history in javascript
Ques :- 78 How do you detect caps lock key turned on or not
Ques :- 79 What is isNaN
Ques :- 80 What are the differences between undeclared and undefined variables
Ques :- 81 What are global variables
Ques :- 82 What are the problems with global variables
Ques :- 83 What is NaN property
Ques :- 84 What is the purpose of isFinite function
Ques :- 85 What is an event flow
Ques :- 86 What is event bubbling
Ques :- 87 What is event capturing
Ques :- 88 How do you submit a form using JavaScript
Ques :- 89 How do you find operating system details
Ques :- 90 What is the difference between document load and DOMContentLoaded events 
Ques :- 91 What is the difference between native, host and user objects
Ques :- 92 What are the tools or techniques used for debugging JavaScript code
Ques :- 93 What are the pros and cons of promises over callbacks
Ques :- 94 What is the difference between an attribute and a property
Ques :- 95 What is same-origin policy
Ques :- 96 What is the purpose of void 0
Ques :- 97 Is JavaScript a compiled or interpreted language
Ques :- 98 Is JavaScript a case-sensitive language
Ques :- 99 Is there any relation between Java and JavaScript 
Ques :- 100 What are events 
Ques :- 101 Who created jaQues :- vascript 
Ques :- 102 What is the use of preventDefault method 
Ques :- 103 What is the use of stopPropagation method 
Ques :- 104 What are the steps involved in return false usage 
Ques :- 105 What is BOM 
Ques :- 106 What is the use of setTimeout 
Ques :- 107 What is the use of setInterval 
Ques :- 108 Why is JavaScrQues :- ipt treated as Single threaded
Ques :- 109 What is an event delegation 
Ques :- 110 What is ECMAScript 
Ques :- 111 What is JSON 
Ques :- 112 What are the syntax rules of JSON 
Ques :- 113 What is the purpose JSON stringify 
Ques :- 114 How do you parse JSON string 
Ques :- 115 Why do you neeQues :- d JSON 
Ques :- 116 What are PWAs
Ques :- 117 What is the purpose of clearTimeout method 
Ques :- 118 What is the purpose of clearInterval method 
Ques :- 119 How do you redirect new page in javascript 
Ques :- 120 How do you check whether a string contains a substring 
Ques :- 121 How do you validate an email in javascript 
Ques :- 122 How do you getQues :-  the current url with javascript 
Ques :- 123 What are the various url properties of location object 
Ques :- 124 How do get query string values in javascript 
Ques :- 125 How do you check if a key exists in an object
Ques :- 126 How do you loop through or enumerate javascript object 
Ques :- 127 How do you test for an empty object 
Ques :- 128 What is an arguments object 
Ques :- 129 How do you makQues :- e first letter of the string in an uppercase 
Ques :- 130 What are the pros and cons of for loop 
Ques :- 131 How do you display the current date in javascript 
Ques :- 132 How do you compare two date objects 
Ques :- 133 How do you check if a string starts with another string 
Ques :- 134 How do you trim a string in javascript 
Ques :- 135 How do you add a key value pair in javascript 
Ques :- 136 Is the '!--' notation represents a special operator 
Ques :- 137 How do you assign default values to variables 
Ques :- 138 How do you define multiline strings 
Ques :- 139 What is an app shell model 
Ques :- 140 Can we define properties for functions 
Ques :- 141 What is the way to find the number of parameters expected by a function 
Ques :- 142 What is a polyfill 
Ques :- 143 What are break and continue statements 
Ques :- 144 What are js labels 
Ques :- 145 What are the benefits of keeping declarations at the top 
Ques :- 146 What are the benefits of initializing variables 
Ques :- 147 What are the recommendations to create new object 
Ques :- 148 How do you define JSON array 
Ques :- 149 How do you generate random integers 
Ques :- 150 Can you write a random integers function to print integers with in a range 
Ques :- 151 What is tree shaking 
Ques :- 152 What is the need of tree shaking 
Ques :- 153 Is it recommended to use eval 
Ques :- 154 What is a Regular ExprQues :- ession 
Ques :- 155 What are the string methods available in Regular expression 
Ques :- 156 What are modifiers in regular expression 
Ques :- 157 What are regular expression patterns 
Ques :- 158 What is a RegExp object 
Ques :- 159 How do you search a string for a pattern 
Ques :- 160 What is the purpose of exec method 
Ques :- 161 How do you change the style of a HTML element 
Ques :- 162 What would be the result of 1+2+'3' 
Ques :- 163 What is a debugger statement 
Ques :- 164 What is the purpose of breakpoints in debugging 
Ques :- 165 Can I use reserved words as identifiers 
Ques :- 166 How do you detect a mobile browser 
Ques :- 167 How do you detect a mobile browser without regexp 
Ques :- 168 How do you get the image width and height using JS 
Ques :- 169 How do you make synchronous HTTP request 
Ques :- 170 How do you make asynchronous HTTP request 
Ques :- 171 How do you convert date to another timezone in javascript 
Ques :- 172 What are the properties used to get size of window 
Ques :- 173 What is a conditional operator in javascript 
Ques :- 174 Can you apply chaining on conditional operator 
Ques :- 175 What are the ways to execute javascript after page load 
Ques :- 176 What is the difference between proto and prototype 
Ques :- 177 Give an example where do you really need semicolon 
Ques :- 178 What is a freeze method 
Ques :- 179 What is the purpose of freeze method 
Ques :- 180 Why do I need to use freeze method 
Ques :- 181 How do you detect a browser language preference 
Ques :- 182 How to convert string to title case with javascript 
Ques :- 183 How do you detect javascript disabled in the page 
Ques :- 184 What are various operators supported by javascript 
Ques :- 185 What is a rest parameter 
Ques :- 186 What happens if you do not use rest parameter as a last argument 
Ques :- 187 What are the bitwise operators available in javascript 
Ques :- 188 What is a spread operator 
Ques :- 189 How do you determine whether object is frozen or not 
Ques :- 190 How do you determine two values same or not using object 
Ques :- 191 What is the purpose of using object is method 
Ques :- 192 How do you copy properties from one object to other 
Ques :- 193 What are the applications of assign method 
Ques :- 194 What is a proxy object 
Ques :- 195 What is the purpose of seal method 
Ques :- 196 What are the applications of seal method 
Ques :- 197 What are the differences between freeze and seal methods 
Ques :- 198 How do you determine if an object is sealed or not 
Ques :- 199 How do you get enumerable key and value pairs 
Ques :- 200 What is the main difference between Object.values and Object.entries method 
Ques :- 201 How can you get the list of keys of any object 
Ques :- 202 How do you create an object with prototype 
Ques :- 203 What is a WeakSet 
Ques :- 204 What are the differences between WeakSet and Set 
Ques :- 205 List down the collection of methods available on WeakSet 
Ques :- 206 What is a WeakMap 
Ques :- 207 What are the differences between WeakMap and Map 
Ques :- 208 List down the collection of methods available on WeakMap 
Ques :- 209 What is the purpose of uneval 
Ques :- 210 How do you encode an URL 
Ques :- 211 How do you decode an URL 
Ques :- 212 How do you print the contents of web page 
Ques :- 213 What is the difference between uneval and eval 
Ques :- 214 What is an anonymous function 
Ques :- 215 What is the precedence order between local and global variables
Ques :- 216 What are javascript accessors 
Ques :- 217 How do you define property on Object constructor 
Ques :- 218 What is the difference between get and defineProperty 
Ques :- 219 What are the advantages of Getters and Setters 
Ques :- 220 Can I add getters and setters using defineProperty method 
Ques :- 221 What is the purpose of switch-case 
Ques :- 222 What are the conventions to be followed for the usage of switch case 
Ques :- 223 What are primitive data types 
Ques :- 224 What are the different ways to access object properties 
Ques :- 225 What are the function parameter rules 
Ques :- 226 What is an error object 
Ques :- 227 When you get a syntax error 
Ques :- 228 What are the different error names from error object 
Ques :- 229 What are the various statements in error handling 
Ques :- 230 What are the two types of loops in javascript 
Ques :- 231 What is nodejs 
Ques :- 232 What is an Intl object 
Ques :- 233 How do you perform language specific date and time formatting 
Ques :- 234 What is an Iterator 
Ques :- 235 How does synchronous iteration works 
Ques :- 236 What is an event loop 
Ques :- 237 What is call stack 
Ques :- 238 What is an event queue 
Ques :- 239 What is a decorator 
Ques :- 240 What are the properties of Intl object 
Ques :- 241 What is an Unary operator 
Ques :- 242 How do you sort elements in an array 
Ques :- 243 What is the purpose of compareFunction while sorting arrays 
Ques :- 244 How do you reversing an array 
Ques :- 245 How do you find min and max value in an array 
Ques :- 246 How do you find min and max values without Math functions 
Ques :- 247 What is an empty statement and purpose of it 
Ques :- 248 How do you get metadata of a module 
Ques :- 249 What is a comma operator 
Ques :- 250 What is the advantage of a comma operator 
Ques :- 251 What is typescript 
Ques :- 252 What are the differences between javascript and typescript 
Ques :- 253 What are the advantages of typescript over javascript 
Ques :- 254 What is an object initializer 
Ques :- 255 What is a constructor method 
Ques :- 256 What happens if you write constructor more than once in a class 
Ques :- 257 How do you call the constructor of a parent class 
Ques :- 258 How do you get the prototype of an object 
Ques :- 259 What happens If I pass string type for getPrototype method 
Ques :- 260 How do you set prototype of one object to another 
Ques :- 261 How do you check whether an object can be extendable or not 
Ques :- 262 How do you prevent an object to extend 
Ques :- 263 What are the different ways to make an object non-extensible 
Ques :- 264 How do you define multiple properties on an object 
Ques :- 265 What is MEAN in javascript 
Ques :- 266 What Is Obfuscation in javascript 
Ques :- 267 Why do you need Obfuscation 
Ques :- 268 What is Minification 
Ques :- 269 What are the advantages of minification 
Ques :- 270 What are the differences between Obfuscation and Encryption 
Ques :- 271 What are the common tools used for minification 
Ques :- 272 How do you perform form validation using javascript 
Ques :- 273 How do you perform form validation without javascript 
Ques :- 274 What are the DOM methods available for constraint validation 
Ques :- 275 What are the available constraint validation DOM properties 
Ques :- 276 What are the list of validity properties 
Ques :- 277 Give an example usage of rangeOverflow property 
Ques :- 278 Is enums feature available in javascript 
Ques :- 279 What is an enum 
Ques :- 280 How do you list all properties of an object 
Ques :- 281 How do you get property descriptors of an object 
Ques :- 282 What are the attributes provided by a property descriptor 
Ques :- 283 How do you extend classes 
Ques :- 284 How do I modify the url without reloading the page 
Ques :- 285 How do you check whether an array includes a particular value or not 
Ques :- 286 How do you compare scalar arrays 
Ques :- 287 How to get the value from get parameters 
Ques :- 288 How do you print numbers with commas as thousand separators 
Ques :- 289 What is the difference between java and javascript 
Ques :- 290 Does javascript supports namespace 
Ques :- 291 How do you declare namespace 
Ques :- 292 How do you invoke javascript code in an iframe from parent page 
Ques :- 293 How do get the timezone offset from date 
Ques :- 294 How do you load CSS and JS files dynamically 
Ques :- 295 What are the different methods to find HTML elements in DOM 
Ques :- 296 What is jQuery 
Ques :- 297 What is V8 JavaScript engine 
Ques :- 298 Why do we call javascript as dynamic language 
Ques :- 299 What is a void operator 
Ques :- 300 How to set the cursor to wait 
Ques :- 301 How do you create an infinite loop 
Ques :- 302 Why do you need to avoid with statement 
Ques :- 303 What is the output of below for loops 
Ques :- 304 List down some of the features of ES6 
Ques :- 305 What is ES6 
Ques :- 306 Can I redeclare let and const variables 
Ques :- 307 Is const variable makes the value immutable 
Ques :- 308 What are default parameters 
Ques :- 309 What are template literals 
Ques :- 310 How do you write multi-line strings in template literals 
Ques :- 311 What are nesting templates 
Ques :- 312 What are tagged templates 
Ques :- 313 What are raw strings 
Ques :- 314 What is destructuring assignment 
Ques :- 315 What are default values in destructuring assignment 
Ques :- 316 How do you swap variables in destructuring assignment 
Ques :- 317 What are enhanced object literals
Ques :- 318 What are dynamic imports 
Ques :- 319 What are the use cases for dynamic imports 
Ques :- 320 What are typed arrays 
Ques :- 321 What are the advantages of module loaders 
Ques :- 322 What is collation 
Ques :- 323 What is for...of statement 
Ques :- 324 What is the output of below spread operator array 
Ques :- 325 Is PostMessage secure 
Ques :- 326 What are the problems with postmessage target origin as wildcard 
Ques :- 327 How do you avoid receiving postMessages from attackers 
Ques :- 328 Can I avoid using postMessages completely 
Ques :- 329 Is postMessages synchronous 
Ques :- 330 What paradigm is Javascript 
Ques :- 331 What is the difference between internal and external javascript 
Ques :- 332 Is JavaScript faster than server side script 
Ques :- 333 How do you get the status of a checkbox 
Ques :- 334 What is the purpose of double tilde operator 
Ques :- 335 How do you convert character to ASCII code 
Ques :- 336 What is ArrayBuffer 
Ques :- 337 What is the output of below string expression 
Ques :- 338 What is the purpose of Error object 
Ques :- 339 What is the purpose of EvalError object 
Ques :- 340 What are the list of cases error thrown from non-strict mode to strict mode
Ques :- 341 Do all objects have prototypes 
Ques :- 342 What is the difference between a parameter and an argument 
Ques :- 343 What is the purpose of some method in arrays 
Ques :- 344 How do you combine two or more arrays 
Ques :- 345 What is the difference between Shallow and Deep copy 
Ques :- 346 How do you create specific number of copies of a string 
Ques :- 347 How do you return all matching strings against a regular expression 
Ques :- 348 How do you trim a string at the beginning or ending 
Ques :- 349 What is the output of below console statement with unary operator 
Ques :- 350 Does javascript uses mixins 
Ques :- 351 What is a thunk function 
Ques :- 352 What are asynchronous thunks 
Ques :- 353 What is the output of below function calls 
Ques :- 354 How to remove all line breaks from a string 
Ques :- 355 What is the difference between reflow and repaint 
Ques :- 356 What happens with negating an array 
Ques :- 357 What happens if we add two arrays 
Ques :- 358 What is the output of prepend additive operator on falsy values 
Ques :- 359 How do you create self string using special characters 
Ques :- 360 How do you remove falsy values from an array 
Ques :- 361 How do you get unique values of an array 
Ques :- 362 What is destructuring aliases 
Ques :- 363 How do you map the array values without using map method 
Ques :- 364 How do you empty an array 
Ques :- 365 How do you rounding numbers to certain decimals 
Ques :- 366 What is the easiest way to convert an array to an object 
Ques :- 367 How do you create an array with some data 
Ques :- 368 What are the placeholders from console object 
Ques :- 369 Is it possible to add CSS to console messages 
Ques :- 370 What is the purpose of dir method of console object 
Ques :- 371 Is it possible to debug HTML elements in console 
Ques :- 372 How do you display data in a tabular format using console object 
Ques :- 373 How do you verify that an argument is a Number or not 
Ques :- 374 How do you create copy to clipboard button 
Ques :- 375 What is the shortcut to get timestamp 
Ques :- 376 How do you flattening multi dimensional arrays 
Ques :- 377 What is the easiest multi condition checking 
Ques :- 378 How do you capture browser back button 
Ques :- 379 How do you disable right click in the web page 
Ques :- 380 What are wrapper objects 
Ques :- 381 What is AJAX 
Ques :- 382 What are the different ways to deal with Asynchronous Code 
Ques :- 383 How to cancel a fetch request 
Ques :- 384 What is web speech API 
Ques :- 385 What is minimum timeout throttling 
Ques :- 386 How do you implement zero timeout in modern browsers 
Ques :- 387 What are tasks in event loop 
Ques :- 388 What is microtask 
Ques :- 389 What are different event loops 
Ques :- 390 What is the purpose of queueMicrotask 
Ques :- 391 How do you use javascript libraries in typescript file 
Ques :- 392 What are the differences between promises and observables 
Ques :- 393 What is heap 
Ques :- 394 What is an event table 
Ques :- 395 What is a microTask queue 
Ques :- 396 What is the difference between shim and polyfill 
Ques :- 397 How do you detect primitive or non primitive value type 
Ques :- 398 What is babel 
Ques :- 399 Is Node.js completely single threaded 
Ques :- 400 What are the common use cases of observables 
Ques :- 401 What is RxJS 
Ques :- 402 What is the difference between Function constructor and function declaration 
Ques :- 403 What is a Short circuit condition 
Ques :- 404 What is the easiest way to resize an array 
Ques :- 405 What is an observable 
Ques :- 406 What is the difference between function and class declarations 
Ques :- 407 What is an async function 
Ques :- 408 How do you prevent promises swallowing errors
Ques :- 410 How do you make an object iterable in javascript
Ques :- 409 What is deno
Ques :- 411 What is a Proper Tail Call
Ques :- 412 How do you check an object is a promise or not
Ques :- 413 How to detect if a function is called as constructor?
Ques :- 414 What are the differences between arguments object and rest parameter?
Ques :- 415 What are the differences between spread operator and rest parameter?
Ques :- 416 What are the different kinds of generators?
Ques :- 417 What are the built-in iterables?
Ques :- 418 What are the differences between for...of and for...in statements?
Ques :- 419 How do you define instance and non-instance properties?
Ques :- 420 What is the difference between isNaN and Number.isNaN?
Ques :- 421 How to invoke an IIFE without any extra brackets?
Ques :- 422 Is that possible to use expressions in switch cases?
Ques :- 423 What is the easiest way to ignore promise errors?
Ques :- 424 How do style the console output using CSS?
Ques :- 425 What is nullish coalescing operator (??)?
Ques :- 426 How do you group and nest console output?
Ques :- 427 What is the difference between dense and sparse arrays
Ques :- 428 What are the different ways to create sparse arrays?
Ques :- 429 What is the difference between setTimeout, setImmediate and process.nextTick?
Ques :- 430 How do you reverse an array without modifying original array?
Ques :- 431 How do you create custom HTML element?
Ques :- 432 What is global execution context?
Ques :- 433 What is function execution context?
Ques :- 434 What is debouncing?
Ques :- 435 What is throttling?
Ques :- 436 What is optional chaining ? 
...
54. ### What is a callback function
    ...
    Left's take a simple example of how to use callback function
...
243. ### What is the purpose of compare Function while sorting arrays
...
High performance :- Express prapare a thin layer therefore the performance is adequate.
